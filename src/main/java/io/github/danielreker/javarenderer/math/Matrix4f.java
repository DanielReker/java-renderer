...
public record Matrix4f(
    ...
    public static Vector4f multiply(Matrix4f matrix4f, Vector4f vector4f) {
        return new Vector4f(
                matrix4f.m00 * vector4f.v0() + matrix4f.m10 * vector4f.v1() + matrix4f.m20 * vector4f.v2() + matrix4f.m30 * vector4f.v3(),
                matrix4f.m01 * vector4f.v0() + matrix4f.m11 * vector4f.v1() + matrix4f.m21 * vector4f.v2() + matrix4f.m31 * vector4f.v3(),
                matrix4f.m02 * vector4f.v0() + matrix4f.m12 * vector4f.v1() + matrix4f.m22 * vector4f.v2() + matrix4f.m32 * vector4f.v3(),
                matrix4f.m03 * vector4f.v0() + matrix4f.m13 * vector4f.v1() + matrix4f.m23 * vector4f.v2() + matrix4f.m33 * vector4f.v3()
        );
    }
